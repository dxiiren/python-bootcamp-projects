...
# Python Bootcamp Projects Bootstrap Setup
#
...
Write-Host ""
Write-Host "Python Bootcamp Projects Bootstrap Setup" -ForegroundColor Cyan
...
Write-Host "  1. Open Jupyter Lab (:8124):  just lab" -ForegroundColor Gray
Write-Host "  2. Headless-run a notebook:       just execute path\to\notebook.ipynb" -ForegroundColor Gray
Write-Host "  3. Login to Claude Code:          claude" -ForegroundColor Gray
Write-Host ""
